...
export function AdminTrialBanner({ organization }: Props) {
  ...
  return (
    <div
      role="status"
      className="mb-6 rounded-xl border border-amber-200/90 bg-amber-50 px-4 py-3 text-sm text-amber-950 dark:border-amber-900/50 dark:bg-amber-950/40 dark:text-amber-100"
    >
